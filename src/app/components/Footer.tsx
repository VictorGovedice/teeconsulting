...
export default function Footer() {
  return (
    <footer className="bg-white text-black pt-16 pb-10 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
        {/* Informações */}
        <div className="space-y-8">
          <div className="text-lg space-y-4 text-center lg:text-left leading-relaxed">
            <div className="flex items-start gap-3">
              ...
              <p><strong>Endereço:</strong> Av. Brig. Faria Lima, 1485 - 2º andar - Pinheiros, São Paulo - SP, 01452-002</p>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <p><strong>Telefone:</strong> (11) 2050-0244</p>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <p>
                <strong>Email:</strong> 
                <a href="mailto:atendimento@loupit.com" className="text-blue-600 hover:underline ml-1">
        ...
        {/* Google Maps */}
        <div className="rounded-lg overflow-hidden shadow-md h-[320px]">
          <iframe
      ...
      <div className="mt-10 text-center text-sm text-gray-500">
        © {new Date().getFullYear()} Loupit. Todos os direitos reservados.
      </div>
    </footer>
  );
}